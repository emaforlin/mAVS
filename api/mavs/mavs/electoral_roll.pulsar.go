...
var (
	...
	fd_ElectoralRoll_voters protoreflect.FieldDescriptor
)

func init() {
	file_mavs_mavs_electoral_roll_proto_init()
	md_ElectoralRoll = File_mavs_mavs_electoral_roll_proto.Messages().ByName("ElectoralRoll")
	fd_ElectoralRoll_voters = md_ElectoralRoll.Fields().ByName("voters")
}

var _ protoreflect.Message = (*fastReflection_ElectoralRoll)(nil)

type fastReflection_ElectoralRoll ElectoralRoll

func (x *ElectoralRoll) ProtoReflect() protoreflect.Message {
	return (*fastReflection_ElectoralRoll)(x)
}

func (x *ElectoralRoll) slowProtoReflect() protoreflect.Message {
	mi := &file_mavs_mavs_electoral_roll_proto_msgTypes[0]
...
var _fastReflection_ElectoralRoll_messageType fastReflection_ElectoralRoll_messageType
var _ protoreflect.MessageType = fastReflection_ElectoralRoll_messageType{}

type fastReflection_ElectoralRoll_messageType struct{}

func (x fastReflection_ElectoralRoll_messageType) Zero() protoreflect.Message {
	return (*fastReflection_ElectoralRoll)(nil)
}
func (x fastReflection_ElectoralRoll_messageType) New() protoreflect.Message {
	return new(fastReflection_ElectoralRoll)
}
func (x fastReflection_ElectoralRoll_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_ElectoralRoll
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_ElectoralRoll) Descriptor() protoreflect.MessageDescriptor {
	return md_ElectoralRoll
}
...
func (x *fastReflection_ElectoralRoll) Type() protoreflect.MessageType {
	return _fastReflection_ElectoralRoll_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_ElectoralRoll) New() protoreflect.Message {
	return new(fastReflection_ElectoralRoll)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_ElectoralRoll) Interface() protoreflect.ProtoMessage {
	return (*ElectoralRoll)(x)
}
...
func (x *fastReflection_ElectoralRoll) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		...
		panic(fmt.Errorf("message mavs.mavs.ElectoralRoll does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_ElectoralRoll) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message mavs.mavs.ElectoralRoll does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_ElectoralRoll) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in mavs.mavs.ElectoralRoll", d.FullName()))
	}
	panic("unreachable")
}
...
func (x *fastReflection_ElectoralRoll) GetUnknown() protoreflect.RawFields {
...
func (x *fastReflection_ElectoralRoll) SetUnknown(fields protoreflect.RawFields) {
...
func (x *fastReflection_ElectoralRoll) IsValid() bool {
	return x != nil
}
...
func (x *fastReflection_ElectoralRoll) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*ElectoralRoll)
		if x == nil {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: ElectoralRoll: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: ElectoralRoll: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
func (x *ElectoralRoll) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ElectoralRoll) ProtoMessage() {}

// Deprecated: Use ElectoralRoll.ProtoReflect.Descriptor instead.
...
var (
	file_mavs_mavs_electoral_roll_proto_rawDescOnce sync.Once
	file_mavs_mavs_electoral_roll_proto_rawDescData = file_mavs_mavs_electoral_roll_proto_rawDesc
)

func file_mavs_mavs_electoral_roll_proto_rawDescGZIP() []byte {
	file_mavs_mavs_electoral_roll_proto_rawDescOnce.Do(func() {
		file_mavs_mavs_electoral_roll_proto_rawDescData = protoimpl.X.CompressGZIP(file_mavs_mavs_electoral_roll_proto_rawDescData)
	})
...
func file_mavs_mavs_electoral_roll_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_mavs_mavs_electoral_roll_proto_goTypes,
		DependencyIndexes: file_mavs_mavs_electoral_roll_proto_depIdxs,
		MessageInfos:      file_mavs_mavs_electoral_roll_proto_msgTypes,
	}.Build()
	File_mavs_mavs_electoral_roll_proto = out.File
	file_mavs_mavs_electoral_roll_proto_rawDesc = nil
	file_mavs_mavs_electoral_roll_proto_goTypes = nil
	file_mavs_mavs_electoral_roll_proto_depIdxs = nil
}
