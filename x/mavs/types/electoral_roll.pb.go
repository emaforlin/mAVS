...
func (m *ElectoralRoll) GetVoters() string {
	if m != nil {
		return m.Voters
	}
	return ""
...
var fileDescriptor_cb4265f59b684714 = []byte{
	...
	0x39, 0x7a, 0x05, 0x45, 0xf9, 0x25, 0xf9, 0x42, 0x9c, 0x20, 0x29, 0x3d, 0x10, 0xa1, 0xa4, 0xce,
	0xc5, 0xeb, 0x0a, 0x53, 0x12, 0x94, 0x9f, 0x93, 0x23, 0x24, 0xc6, 0xc5, 0x56, 0x96, 0x5f, 0x92,
	0x5a, 0x54, 0x2c, 0xc1, 0xa8, 0xc0, 0xa8, 0xc1, 0x19, 0x04, 0xe5, 0x39, 0x39, 0x9c, 0x78, 0x24,
	...
	0x72, 0x7e, 0xae, 0x7e, 0x6a, 0x6e, 0x62, 0x5a, 0x7e, 0x51, 0x4e, 0x66, 0x9e, 0x7e, 0xae, 0x63,
	0x58, 0xb0, 0x7e, 0x05, 0xc4, 0x11, 0x25, 0x95, 0x05, 0xa9, 0xc5, 0x49, 0x6c, 0x60, 0xcb, 0x8d,
	0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0xb2, 0x5f, 0x66, 0x61, 0x9e, 0x00, 0x00, 0x00,
}
...
func (m *ElectoralRoll) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Voters) > 0 {
		...
		i = encodeVarintElectoralRoll(dAtA, i, uint64(len(m.Voters)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *ElectoralRoll) Size() (n int) {
	...
	l = len(m.Voters)
	if l > 0 {
		n += 1 + l + sovElectoralRoll(uint64(l))
	}
	return n
}
